...
\begin{figure}[H]
    \centering
    \begin{minipage}{0.7\textwidth}
        Google Colab is a cloud-based Jupyter Notebook environment that provides free access to GPUs and TPUs. It is ideal for machine learning, data analysis, and education, enabling users to write and execute code directly in the browser with minimal setup.
    \end{minipage}%
    \hfill
    \begin{minipage}{0.2\textwidth}
        \centering
...
Visual design was essential for planning and presenting the system. This section covers tools used to create UI mockups and system diagrams, aiding in workflow visualization and user experience design.
...
\begin{figure}[H]
    \centering
    \begin{minipage}{0.7\textwidth}
        Tailwind CSS is a utility-first framework that allows rapid and responsive UI development using pre-defined classes. It streamlines styling directly in HTML or JSX, offering flexibility and consistency without writing custom CSS.
    \end{minipage}%
    \hfill
    \begin{minipage}{0.2\textwidth}
        \centering
