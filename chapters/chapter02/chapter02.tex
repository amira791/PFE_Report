...
In this section, we introduce the core principles of \gls{abb:dl}, focusing on \gls{abb:dnn}s and their role in learning complex patterns from data. We explore the structure and components of neural networks, the learning process, optimization techniques, and model evaluation methods. Additionally, we highlight regularization strategies to prevent overfitting.
...
\begin{figure}[H] % 'H' needs \usepackage{float}
    \centering
    \includegraphics[width=0.6\textwidth]{chapters/chapter02/images/Figure01.png}
...
\gls{abb:cnn}s consist of multiple layers designed to process and learn spatial hierarchies from image data \parencite{alzubaidi2021review}. Their architecture typically includes:
...
\begin{figure}[H] % 'H' needs \usepackage{float}
    \centering
    \includegraphics[width=0.7\textwidth]{chapters/chapter02/images/Figure17.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{chapters/chapter02/images/Figure19.png}
...
\begin{figure}[H] % 'H' needs \usepackage{float}
    \centering
    \includegraphics[width=0.6\textwidth]{chapters/chapter02/images/Figure21.png}
