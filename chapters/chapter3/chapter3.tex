...
The detailed formulas for the vegetation indices (VIs) used in the studies mentioned are provided in Annex~\ref{app:annexA}.
\begin{table}[htbp]
...
\begin{table}[htbp]
    ...
    \centering
    \resizebox{\textwidth}{!}{%
    \begin{tabular}{|p{3.5cm}|p{2.5cm}|p{2cm}|p{4cm}|p{3.5cm}|p{3cm}|}
    \hline
